...
(function (root, reduce) {
  if (typeof module == 'object') (module.exports = reduce) // CommonJS
  else if (typeof define == 'function') define(() => reduce) // AMD
  else (root.reduce = reduce) // Browser
