...
(function (root, reject) {
  if (typeof module == 'object') (module.exports = reject) // CommonJS
  else if (typeof define == 'function') define(() => reject) // AMD
  else (root.reject = reject) // Browser
